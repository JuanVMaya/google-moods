...
import people from "../../assets/Sign-inPeople.svg";
      ...
      <article className="sign-in__main">
        ...
        <form action="submit" className="sign-in__form">
          ...
          <section className="sign-in__outer-button">
            <Link to="/" className="sign-in__inner-button">
              Next
            </Link>
          </section>
          ...
          <p className="sign-in__create-account">Create Account</p>
        </form>
      </article>
      <img src={people} alt="three people" className="sign-in__img" />
    </main>
  );
};
